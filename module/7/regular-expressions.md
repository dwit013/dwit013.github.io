...
Say you want to search for cellphone numbers in a document full of text. You would define a regular expression for it as `\b(\+977-)?98[0-9]{8}\b`.
...
Adding parentheses will create groups in the regex: ` \b(\+977-) ? (98[0-9]{8})\b `. Then you can use the group() match object method to grab the matching text from just one group. The first set of parentheses in a regex string will be group 1. The second set will be group 2 and so on.
...
Example I
    ...
    matchObj = re.match(r'\b(\+977-)?(98[0-9]{8})\b', '9841234567')
...
Example II
    ...
    matchObj = re.match(r'\b(\+977-)?(98[0-9]{8})\b', '+977-9841234567')
...
The re.search function returns a match object on success, **None** on failure. 
    ...
    matchObj = re.search(r'\b(\+977-)?(98[0-9]{8})\b', note)
...
If one or more groups are present in the pattern, return a list of groups; this will be a list of tuples if the pattern has more than one group.
    ...
    note = "Come to college tomorrow and call me at 9841234567 or 9808987654"
    matchObj = re.findall(r'\b(\+977-)?(98[0-9]{8})\b', note)
    matchObj

Output

    [('', '9841234567'), ('', '9808987654')]
